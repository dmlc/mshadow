...
elseif(BLAS STREQUAL "Apple" OR BLAS STREQUAL "apple")
  find_package(BLAS REQUIRED)
  include_directories(SYSTEM ${BLAS_Accelerate_LIBRARY}/Frameworks/vecLib.framework/Headers/)
  list(APPEND mshadow_LINKER_LIBS ${BLAS_Accelerate_LIBRARY})
  add_definitions(-DMSHADOW_USE_CBLAS=1)
  add_definitions(-DMSHADOW_USE_MKL=0)
endif()
