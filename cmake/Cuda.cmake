...
if(CUDA_ARCH_ALL)
  ...
  if(${CUDA_VERSION} EQUAL 10.0 OR ${CUDA_VERSION} GREATER 10.0)
    set(mshadow_known_gpu_archs "30 35 50 52 60 61 70 75")
  elseif(${CUDA_VERSION} EQUAL 9.0 OR ${CUDA_VERSION} GREATER 9.0)
